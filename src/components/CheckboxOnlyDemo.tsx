...
export default function CheckboxOnlyDemo() {
  ...
  return (
    <div style={{ margin: '10px' }}>
      <Provider ripple={true}>
        <h2 style={{ margin: '10px' }}>Checkbox-only selection</h2>

        <div style={{ margin: '10px' }}>
          <Button onClick={() => setSelectionSettings((s: any) => ({ ...s, checkboxOnly: !s.checkboxOnly }))} className='e-primary' style={{ marginRight: '10px' }}>
            {selectionSettings.checkboxOnly ? 'Disable checkbox-only' : 'Enable checkbox-only'}
          </Button>
