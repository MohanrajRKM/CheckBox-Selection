...
export default function PersistRemoteDemo() {
  const gridRef = useRef<GridRef>(null);

  // Remote data source (supports CRUD/paging). Primary key: OrderID
  ...
  const [pageSettings] = useState<PageSettings>({ enabled: true, pageSize: 12, pageCount: 4 });
  ...
  return (
    <div style={{ margin: '10px' }}>
      <Provider ripple={true}>
        <h2 style={{ margin: '10px' }}>Persist selection - Remote data</h2>
